...
// Convert options from String-formatted to Object-formatted if needed
    ...
    jQuery.ajax = function(url, options) {
        ...
        ///     A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for any
        ///     option with $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all settings.
        /// </param>
...
// Set document vars if needed
    ...
    jQuery.data = function(elem, name, data) {
        ...
        ///     &#10;2: Returns value at named data store for the element, as set by jQuery.data(element, name, value), or the full
...
// shift arguments if data argument was omitted
    ...
    jQuery.grep = function(elems, callback, inv) {
        ...
        /// </param>
        /// <param name="callback" type="Function">
        ///     The function to process each item against.  The first argument to the function is the item, and the second argument
        ///     is the index.  The function should return a Boolean value.  this will be the global window object.
        /// </param>
        /// <param name="inv" type="Boolean">
        ///     If "invert" is false, or not provided, then the function returns an array consisting of all elements for which
        ///     "callback" returns true.  If "invert" is true, then the function returns an array consisting of all elements for
...
// documentElement is verified for cases where it doesn't yet exist
    ...
    jQuery.map = function(elems, callback, arg) {
        ...
        /// </param>
        /// <param name="callback" type="Function">
        ///     The function to process each item against.  The first argument to the function is the array item, the second
        ///     argument is the index in array The function can return any value. Within the function, this refers to the global
        ///     (window) object.
        /// </param>
        /// <returns type="Array" />
        var value,
...
// shift arguments if data argument was omitted
    ...
    jQuery.prototype.after = function() {
        ...
        /// </param>
        /// <param name="" type="">
        ///     One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert after each
    ...
    jQuery.prototype.append = function() {
        ...
        /// </param>
        /// <param name="" type="">
        ///     One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert at the end of
    ...
    jQuery.prototype.appendTo = function(selector) {
        ...
        ///     A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted at the end of the
    ...
    jQuery.prototype.before = function() {
        ...
        /// </param>
        /// <param name="" type="">
        ///     One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert before each
        ///     element in the set of matched elements.
        /// </param>
        /// <returns type="jQuery" />
        return this.domManip(arguments, function(elem) {
    ...
    jQuery.prototype.clone = function(dataAndEvents, deepDataAndEvents) {
        ...
        ///     false. *In jQuery 1.5.0 the default value was incorrectly true; it was changed back to false in 1.5.1 and up.
        /// </param>
        /// <param name="deepDataAndEvents" type="Boolean">
        ///     A Boolean indicating whether event handlers and data for all children of the cloned element should be copied. By
        ///     default its value matches the first argument's value (which defaults to false).
        /// </param>
        /// <returns type="jQuery" />
    ...
    jQuery.prototype.closest = function(selectors, context) {
        /// <summary>
        ///     1: For each element in the set, get the first element that matches the selector by testing the element itself and
        ...
        /// </param>
        /// <param name="context" domElement="true">
        ///     A DOM element within which a matching element may be found. If no context is passed in then the context of the
        ///     jQuery set will be used instead.
        /// </param>
        /// <returns type="jQuery" />
        var cur,
            i = 0,
    ...
    jQuery.prototype.data = function(key, value) {
        ...
        ///     &#10;    1.1 - data(key, value)
        ///     &#10;    1.2 - data(obj)
        ///     &#10;2: Return the value at the named data store for the first element in the jQuery collection, as set by
    ...
    jQuery.prototype.delegate = function(selector, types, data, fn) {
        ...
        /// </param>
        /// <param name="types" type="String">
        ///     A string containing one or more space-separated JavaScript event types, such as "click" or "keydown," or custom
        ///     event names.
        /// </param>
        /// <param name="data" type="Object">
        ///     An object containing data that will be passed to the event handler.
...
// show any hidden elements after setting opacity to 0
    ...
    jQuery.prototype.height = function(margin, value) {
        ...
        ///     An integer representing the number of pixels, or an integer with an optional unit of measure appended (as a
        ///     string).
        /// </param>
        /// <returns type="jQuery" />
    ...
    jQuery.prototype.hover = function(fnOver, fnOut) {
        ...
        ///     &#10;2: Bind a single handler to the matched elements, to be executed when the mouse pointer enters or leaves the
        ///     elements.
...
// No argument, return index in parent
    ...
    jQuery.prototype.insertAfter = function(selector) {
        ...
        /// </summary>
        /// <param name="selector" type="">
        ///     A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted after the
        ///     element(s) specified by this parameter.
        /// </param>
        /// <returns type="jQuery" />
        var elems,
    ...
    jQuery.prototype.insertBefore = function(selector) {
        ...
        /// </summary>
        /// <param name="selector" type="">
        ///     A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted before the
        ///     element(s) specified by this parameter.
        /// </param>
        /// <returns type="jQuery" />
        var elems,
    ...
    jQuery.prototype.on = function(types, selector, data, fn, /*INTERNAL*/ one) {
        ...
        /// </param>
        /// <param name="fn" type="Function">
        ///     A function to execute when the event is triggered. The value false is also allowed as a shorthand for a function
        ///     that simply does return false.
        /// </param>
        /// <returns type="jQuery" />
        var origFn, type;
    ...
    jQuery.prototype.prepend = function() {
        ...
        /// </summary>
        /// <param name="" type="">
        ///     DOM element, array of elements, HTML string, or jQuery object to insert at the beginning of each element in the set
        ///     of matched elements.
        /// </param>
        /// <param name="" type="">
        ///     One or more additional DOM elements, arrays of elements, HTML strings, or jQuery objects to insert at the beginning
    ...
    jQuery.prototype.prependTo = function(selector) {
        ...
        /// </summary>
        /// <param name="selector" type="">
        ///     A selector, element, HTML string, or jQuery object; the matched set of elements will be inserted at the beginning
...
// Add the callback
    ...
    jQuery.prototype.scrollTop = function(val) {
        /// <summary>
        ///     1: Get the current vertical position of the scroll bar for the first element in the set of matched elements or set
...
// ( namespace ) or ( selector, types [, fn] )
    ...
    jQuery.prototype.val = function(value) {
        ...
        /// </summary>
        /// <param name="value" type="">
        ///     A string of text or an array of strings corresponding to the value of each matched element to set as
        ///     selected/checked.
        /// </param>
        /// <returns type="jQuery" />
        var hooks,
    ...
    jQuery.prototype.width = function(margin, value) {
        ...
        /// </summary>
        /// <param name="margin" type="">
        ///     An integer representing the number of pixels, or an integer along with an optional unit of measure appended (as a
        ///     string).
        /// </param>
        /// <returns type="jQuery" />
        var chainable = arguments.length && (defaultExtra || typeof margin !== "boolean"),
    ...
    jQuery.prototype.wrapInner = function(html) {
        ...
        ///     An HTML snippet, selector expression, jQuery object, or DOM element specifying the structure to wrap around the
