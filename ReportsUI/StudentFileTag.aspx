<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="StudentFileTag.aspx.cs" Inherits="ReportsUI_StudentFileTag" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <fieldset>
        <legend><h1>Student File Tag Report</h1></legend>
        <table>
            <tr>
                <td>
                    <b>Session: </b>
        ...
        <CR:CrystalReportViewer ID="StudentFileTagReport" runat="server" 
