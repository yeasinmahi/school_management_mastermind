<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SubjectWiseMarksEntryReport.aspx.cs" Inherits="ReportsUI_SubjectWiseMarksEntryReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <fieldset>
        <legend>
            <h1>
                Subject Wise Marks Entry Report(FINAL)</h1>
        </legend>
        <table>
            <tr>
                <td>
        ...
        <div>
            <CR:CrystalReportViewer ID="StudentMarksSheet" runat="server" 
