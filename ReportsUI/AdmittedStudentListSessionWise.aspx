<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AdmittedStudentListSessionWise.aspx.cs" Inherits="ReportsUI_AdmittedStudentListSessionWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     <fieldset>
        <legend>
            <h1>
                Total Number Of New Admitted Student</h1>
        </legend>
        <table>
            <tr>
                <td>
