<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="BoardExamResult.aspx.cs" Inherits="ReportsUI_BoardExamResult" %>
                    ...
                    <div class="col-sm-12 form-group" style="margin-top: 10px">
                        ...
                        <div class="col-sm-2">
                            <asp:Button ID="fullResultButton" runat="server" Text="FULL RESULT" 
                                CssClass="btn btn-info" onclick="fullResultButton_Click"/>
                        </div>
                        <div class="col-sm-2">
                            <asp:Button ID="topTenButton" runat="server" Text="TOP 10" 
                                CssClass="btn btn-warning" onclick="topTenButton_Click"/>
                        </div>
                        <div class="col-sm-2">
                            <asp:Button ID="totalGradeButton" runat="server" Text="OBTAIN GRADE SUMMARY" 
                                CssClass="btn btn-yahoo" onclick="totalGradeButton_Click"/>
                        </div>
                        <div class="col-sm-3"></div>
                    </div>
                    <div class="col-sm-12 form-group" style="">
                        ...
                        <div class="col-sm-4">
                            <asp:Button ID="subCountButton" runat="server" Text="RESULT WITH SUBJECT COUNT" 
                                CssClass="btn btn-success" onclick="subCountButton_Click"  />
                        </div>
                        <div class="col-sm-4">
                            <asp:Button ID="awardStdButton" runat="server" Text="AWARD LIST" 
                                CssClass="btn btn-primary" onclick="awardStdButton_Click" />
                        </div>
                        <div class="col-sm-2"></div>
                    </div>
                    <div class="col-sm-12">
                        <CR:CrystalReportViewer ID="BoardResult" runat="server" 
