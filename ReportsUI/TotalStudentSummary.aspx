<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TotalStudentSummary.aspx.cs" Inherits="ReportsUI_TotalStudentSummary" %>
    ...
    <fieldset>
        ...
        <table>
            <tr>
                ...
                <td>
                    <asp:CheckBox ID="classModeCheckBox" runat="server" Text="For Single CLass"/>
                </td>
                <td><br/>
        ...
        <CR:CrystalReportViewer ID="TotalStudentSummary" runat="server" AutoDataBind="true" 
